...
<div style="padding:40px;">
    ...
    <div class="flex justify-between gap-2 mb-6 items-center">
        <a href="{{ route('admin.karya.create') }}" class="bg-cyan-400 text-[#0A192F] px-6 py-2 rounded-lg font-semibold hover:bg-cyan-300 transition">
            + Tambah Karya
        </a>

        {{-- FILTER --}}
        <form method="GET" action="{{ route('admin.karya.index') }}" id="filterForm">
    ...
    <div class="grid-karya">
        ...
        <div class="card-karya">
            ...
            <div class="flex justify-between mb-4 items-center">
                ...
                {{-- Tombol Hapus --}}
                <form action="{{ route('admin.karya.destroy',$content->content_id) }}"
                      method="POST"
